...
# Enciclopedia de 2° básico para Chat Escolar
...
```text
segundo_basico/lenguaje/
segundo_basico/matematica/
segundo_basico/ciencias_naturales/
segundo_basico/historia_geografia/
```

Excluir de la primera indexación:

```text
segundo_basico/compendios/
segundo_basico/evaluaciones/
segundo_basico/bancos/
```
